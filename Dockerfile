...
# lockless resolve; the opt-out is scoped to it. The install below and the runtime `composer ci` read the
# lock this step writes, so they keep full security blocking.
#
